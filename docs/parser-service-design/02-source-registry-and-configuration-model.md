...
Долговечность этих изменений зависит не от самого сервиса, а от того, смонтирован ли `/app/config` поверх image-copy на уровне инфраструктуры.
...
- всего источников: `27`
- `27` включены (`enabled = true`)
- `26` доступны для bulk sync по умолчанию (`sync_enabled = true`)
- режимы:
